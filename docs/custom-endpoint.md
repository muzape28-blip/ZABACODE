...
ZABACODE v1.2.0 includes a neutral **Custom Endpoint** provider.

Philosophy: Tools stay as tools. This provider lets you bring your own LLM without permanent branding in app identity.

## How to Use

1. Open ZABACODE → AI Panel → Provider dropdown → `🔧 custom endpoint`
...
- In ZABACODE, set custom key to `http://192.168.1.10:11434/v1`
