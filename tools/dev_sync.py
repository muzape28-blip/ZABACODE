#!/usr/bin/env python3
"""
ZABACODE dev sync helper — neutral workspace tooling
...
def verify():
    print("=== Verifying ZABACODE Neutral Integration ===\n")
    ok = True
    ...
    if '"1.2.0"' in init_text and "-arena" not in init_text and "__integration__" not in init_text:
        print("✅ __init__.py version neutral (1.2.0, no __integration__)")
    else:
